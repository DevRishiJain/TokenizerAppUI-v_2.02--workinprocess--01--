...
import INPUTcomplex2 from "../components/INPUTcomplex2";
...
The Tokenizer Account and Tokenizer Visa® Card are provided by Evolve Bank & Trust, Member FDIC.`}
      ...
      <INPUTcomplex2
        ...
        electronicCommunicationCo={`Electronic 
Communication Consent`}
        prop="."
        onINPUTcomplexPress={() => navigation.navigate("Summary3")}
      />
      <Pressable
      ...
      <INPUTcomplex1 />
      <INPUTcomplex2
        iHaveReadAndAgreeToThe={`By applying for a Tokenizer Account and 
providing your contact details, you are 
agreeing to the `}
        electronicCommunicationCo="Privacy Policy"
        prop={` which outlines 
