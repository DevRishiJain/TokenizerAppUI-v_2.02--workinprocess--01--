...
const INPUTcomplex4 = ({
  ...
  const iNPUTcomplex2Style = useMemo(() => {
    return {
  ...
  return (
    <View style={[styles.inputcomplex, iNPUTcomplex2Style]}>
      <Image
      ...
      <View style={[styles.type, styles.typeFlexBox]}>
        <Text style={[styles.txt, styles.txtTypo]}>
          <Text style={styles.iHaveRead}>{consentText}</Text>
          <Text style={styles.electronicCommunicationCons}>{legalText}</Text>
          <Text style={styles.iHaveRead}>{agreementText}</Text>
        </Text>
      </View>
